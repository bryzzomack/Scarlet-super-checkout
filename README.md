...
## GitHub Pages update
Replace the files in your existing repository with the new index.html, manifest.webmanifest, sw.js, and icons. Commit to main. The service-worker cache is versioned v6 to force a fresh app shell.
...
## New in v6 — Faster, More Lifelike Scanning
